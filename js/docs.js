  ...
  },
  {
    ...
    "body": [
      ...
      [
        ...
        [
          { "type": "paragraph", "text": "Tract data describes the location and phasing for planned residential development within the District. Including tract data allows your forecast to account for future housing development and generate development summary or project summary reports." },
          { "type": "paragraph", "text": "If you imported tract data in Data Setup, you can choose to use it in your forecast by checking Use Tract Data and selecting which tract dataset to include." },
          { "type": "paragraph", "text": "Assessor data contains parcel information that has been geocoded to a street network. Including assessor data allows maturation and build-out information to be added to the forecast. This information is used in projected housing units and student yield calculations." },
          { "type": "paragraph", "text": "The housing types in the assessor file should match the housing types defined in the tract dataset. Once all fields are properly filled in, click Finish to create the forecast." }
        ]
      ],
      [
        "Copy a forecast",
        [
          { "type": "paragraph", "text": "You can also create a new forecast by copying an existing forecast. This is useful when you want to make initial base changes that should apply to all later variations." },
          { "type": "paragraph", "text": "From the Catalog pane, open Maps, find the map that contains the forecast, right-click it, choose Copy, then right-click the Maps folder and choose Paste. A copy of the forecast will appear with the same name and a number appended." },
          { "type": "paragraph", "text": "You can then rename the forecast map as needed. SchoolSite Pro will update the forecast tables and name references automatically." }
        ]
      ]
    ]
  },
    ...
    "body": [
      [
        ...
        [
          ...
          { "type": "paragraph", "text": "SchoolSite Enrollment Forecasts use current resident and enrollment information, along with historic student mobility, to calculate an estimated enrollment for each school. This method helps evaluate the current state of facilities and future staffing needs." },
          { "type": "paragraph", "text": "Historical students are selected based on the same criteria used to generate the residential forecast. If your residential forecast included special education or independent study students, those student types are included when calculating transfers into and out of a school’s attendance zone." }
        ]
      ],
      [
      ...
      [
        ...
        [
          ...
          { "type": "paragraph", "text": "This approach provides a practical estimate of future staffing loads where attendance boundaries do not necessarily define the student population in the same way as a traditional neighborhood school." }
        ]
      ]
    ]
  },
      ...
      [
        ...
        [
          ...
          },
          {
            "type": "ordered",
            "items": [
              "Click on the drop down menu for Modify factor in the forcasting ribbon and choose Maturation.",
